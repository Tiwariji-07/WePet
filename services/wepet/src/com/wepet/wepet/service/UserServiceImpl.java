 ...
 * @see User
 */
@Service("wepet.UserService")
@Validated
@EntityService(entityClass = User.class, serviceId = "wepet")
public class UserServiceImpl implements UserService {
    ...
    @Transactional(readOnly = true, value = "wepetTransactionManager")
    @Override
    public User getByPhoneNo(int phoneNo) {
        Map<String, Object> phoneNoMap = new HashMap<>();
        phoneNoMap.put("phoneNo", phoneNo);

        LOGGER.debug("Finding User by unique keys: {}", phoneNoMap);
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service wepet for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service wepet for table User to {} format", options.getExportType());
