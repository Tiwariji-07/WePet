 ...
 * @see AnimalType
 */
@Service("wepet.AnimalTypeService")
@Validated
@EntityService(entityClass = AnimalType.class, serviceId = "wepet")
public class AnimalTypeServiceImpl implements AnimalTypeService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service wepet for table AnimalType to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service wepet for table AnimalType to {} format", options.getExportType());
