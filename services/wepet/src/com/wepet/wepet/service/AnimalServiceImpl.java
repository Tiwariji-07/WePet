 ...
 * @see Animal
 */
@Service("wepet.AnimalService")
@Validated
@EntityService(entityClass = Animal.class, serviceId = "wepet")
public class AnimalServiceImpl implements AnimalService {
    ...
    @Transactional(readOnly = true, value = "wepetTransactionManager")
    @Override
    public Animal getBySize(String size) {
        Map<String, Object> sizeMap = new HashMap<>();
        sizeMap.put("size", size);

        LOGGER.debug("Finding Animal by unique keys: {}", sizeMap);
        return this.wmGenericDao.findByUniqueKey(sizeMap);
    }

    @Transactional(readOnly = true, value = "wepetTransactionManager")
    @Override
    public Animal getByAge(int age) {
        Map<String, Object> ageMap = new HashMap<>();
        ageMap.put("age", age);

        LOGGER.debug("Finding Animal by unique keys: {}", ageMap);
        return this.wmGenericDao.findByUniqueKey(ageMap);
    }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service wepet for table Animal to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service wepet for table Animal to {} format", options.getExportType());
