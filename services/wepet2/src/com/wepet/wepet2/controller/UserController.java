...
import com.wepet.wepet2.service.UserService;
...
public class UserController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public User getByPhoneNo(@PathVariable("phoneNo") long phoneNo) {
        LOGGER.debug("Getting User with uniques key PhoneNo");
    ...
    public Page<Adoption> findAssociatedAdoptions(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return userService.findAssociatedAdoptions(id, pageable);
    }
    ...
    public Page<Complain> findAssociatedComplains(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return userService.findAssociatedComplains(id, pageable);
    }
    ...
    public Page<Donation> findAssociatedDonations(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return userService.findAssociatedDonations(id, pageable);
    }
    ...
    public Page<Volunteer> findAssociatedVolunteers(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return userService.findAssociatedVolunteers(id, pageable);
    }
