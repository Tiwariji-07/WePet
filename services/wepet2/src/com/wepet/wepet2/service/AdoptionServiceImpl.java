 ...
 * @see Adoption
 */
@Service("wepet2.AdoptionService")
@Validated
@EntityService(entityClass = Adoption.class, serviceId = "wepet2")
public class AdoptionServiceImpl implements AdoptionService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service wepet2 for table Adoption to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service wepet2 for table Adoption to {} format", options.getExportType());
