 ...
 * @see User
 */
@Service("wepet2.UserService")
@Validated
@EntityService(entityClass = User.class, serviceId = "wepet2")
public class UserServiceImpl implements UserService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service wepet2 for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service wepet2 for table User to {} format", options.getExportType());
