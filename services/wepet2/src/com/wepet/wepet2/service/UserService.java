...
public interface UserService {
    ...
    /**
     * Find and return the User for given phoneNo  if exists.
     *
    ...
    /*
     * Returns the associated adoptions for given User id.
     *
    ...
    /*
     * Returns the associated complains for given User id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
    ...
    /*
     * Returns the associated donations for given User id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Donation instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Donation> findAssociatedDonations(Integer id, Pageable pageable);

    /*
     * Returns the associated volunteers for given User id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Volunteer instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Volunteer> findAssociatedVolunteers(Integer id, Pageable pageable);
